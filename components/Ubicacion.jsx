  ...
  return (
    <section id="ubicacion" className="py-20 px-6 bg-notaria-gris">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        {/* Mapa con altura fija y sin cambios de diseño */}
        <div className="md:col-span-2">
          <h3 className="text-3xl font-bold text-notaria-azul mb-6 text-center md:text-left">
            ¿Dónde estamos?
          </h3>
        ...
        {/* Horario, sin autoalineación vertical que cause saltos */}
        <div className="bg-notaria-blanco p-6 rounded-xl shadow-md border text-center md:text-left h-fit">
